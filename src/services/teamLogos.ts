...
export const CANONICAL_TEAM_LOGOS: Record<string, TeamLogoInfo> = {
  ...
  'como': {
    name: 'Como',
    shortName: 'COM',
    logo: 'https://a.espncdn.com/i/teamlogos/soccer/500/2926.png',
    primaryColor: '#003B70',
    secondaryColor: '#FFFFFF',
  },
  'verona': {
  ...
  'lecce': {
    name: 'Lecce',
    shortName: 'LEC',
    logo: 'https://a.espncdn.com/i/teamlogos/soccer/500/2923.png',
    primaryColor: '#FFE500',
  ...
  'st. pauli': {
    name: 'FC St. Pauli',
    shortName: 'STP',
    logo: 'https://a.espncdn.com/i/teamlogos/soccer/500/133.png',
    primaryColor: '#6B4C35',
    secondaryColor: '#FFFFFF',
  },
  'heidenheim': {
  ...
  'bochum': {
    name: 'VfL Bochum',
    shortName: 'BOC',
    logo: 'https://a.espncdn.com/i/teamlogos/soccer/500/123.png',
    primaryColor: '#005CA9',
    secondaryColor: '#FFFFFF',
  },
  ...
  'tusker': {
    name: 'Tusker FC',
    shortName: 'TUS',
    logo: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><circle cx="50" cy="50" r="46" fill="%23FFD100" stroke="%23000000" stroke-width="4"/><text x="50" y="58" font-size="22" font-weight="900" font-family="sans-serif" fill="%23000000" text-anchor="middle">TUS</text></svg>',
    primaryColor: '#FFD100',
    secondaryColor: '#000000',
  },
  'kenya police': {
    ...
    shortName: 'POL',
    logo: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><circle cx="50" cy="50" r="46" fill="%23002B49" stroke="%23C4122E" stroke-width="4"/><text x="50" y="58" font-size="22" font-weight="900" font-family="sans-serif" fill="%23FFFFFF" text-anchor="middle">POL</text></svg>',
    primaryColor: '#002B49',
    secondaryColor: '#C4122E',
  },
  'bandari': {
    name: 'Bandari FC',
    shortName: 'BAN',
    logo: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><circle cx="50" cy="50" r="46" fill="%23005BAA" stroke="%23FFD100" stroke-width="4"/><text x="50" y="58" font-size="22" font-weight="900" font-family="sans-serif" fill="%23FFFFFF" text-anchor="middle">BAN</text></svg>',
    primaryColor: '#005BAA',
    secondaryColor: '#FFD100',
  },
  'kcb': {
    name: 'KCB FC',
    shortName: 'KCB',
    logo: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><circle cx="50" cy="50" r="46" fill="%23008751" stroke="%23005BAA" stroke-width="4"/><text x="50" y="58" font-size="22" font-weight="900" font-family="sans-serif" fill="%23FFFFFF" text-anchor="middle">KCB</text></svg>',
    primaryColor: '#008751',
  ...
  'shabana': {
    name: 'Shabana FC',
    shortName: 'SHA',
    logo: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><circle cx="50" cy="50" r="46" fill="%23E20613" stroke="%23FFFFFF" stroke-width="4"/><text x="50" y="58" font-size="22" font-weight="900" font-family="sans-serif" fill="%23FFFFFF" text-anchor="middle">SHA</text></svg>',
    primaryColor: '#E20613',
    secondaryColor: '#FFFFFF',
  },
  'ulinzi stars': {
    name: 'Ulinzi Stars',
    shortName: 'ULI',
    logo: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><circle cx="50" cy="50" r="46" fill="%238A1538" stroke="%23FFCD00" stroke-width="4"/><text x="50" y="58" font-size="22" font-weight="900" font-family="sans-serif" fill="%23FFFFFF" text-anchor="middle">ULI</text></svg>',
    primaryColor: '#8A1538',
    secondaryColor: '#FFCD00',
  },
  'kakamega homeboyz': {
    ...
    shortName: 'KHB',
    logo: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><circle cx="50" cy="50" r="46" fill="%23FFE500" stroke="%23005BAA" stroke-width="4"/><text x="50" y="58" font-size="22" font-weight="900" font-family="sans-serif" fill="%23005BAA" text-anchor="middle">KHB</text></svg>',
    primaryColor: '#FFE500',
    secondaryColor: '#005BAA',
  },
  'nairobi city stars': {
    ...
    shortName: 'NCS',
    logo: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><circle cx="50" cy="50" r="46" fill="%23005BAA" stroke="%23FFFFFF" stroke-width="4"/><text x="50" y="58" font-size="22" font-weight="900" font-family="sans-serif" fill="%23FFFFFF" text-anchor="middle">NCS</text></svg>',
    primaryColor: '#005BAA',
    secondaryColor: '#FFFFFF',
  },
  'bidco united': {
    name: 'Bidco United',
    shortName: 'BID',
    logo: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><circle cx="50" cy="50" r="46" fill="%23F58220" stroke="%23002B49" stroke-width="4"/><text x="50" y="58" font-size="22" font-weight="900" font-family="sans-serif" fill="%23FFFFFF" text-anchor="middle">BID</text></svg>',
    primaryColor: '#F58220',
    secondaryColor: '#002B49',
  },
  'kariobangi sharks': {
    ...
    shortName: 'SHA',
    logo: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><circle cx="50" cy="50" r="46" fill="%23F7D000" stroke="%23008751" stroke-width="4"/><text x="50" y="58" font-size="22" font-weight="900" font-family="sans-serif" fill="%23008751" text-anchor="middle">SHA</text></svg>',
    primaryColor: '#F7D000',
  ...
  'muranga seal': {
    name: "Murang'a Seal",
    shortName: 'MSL',
    logo: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><circle cx="50" cy="50" r="46" fill="%23FDB913" stroke="%23000000" stroke-width="4"/><text x="50" y="58" font-size="22" font-weight="900" font-family="sans-serif" fill="%23000000" text-anchor="middle">MSL</text></svg>',
    primaryColor: '#FDB913',
    secondaryColor: '#000000',
  },
  'posta rangers': {
    name: 'Posta Rangers',
    shortName: 'POS',
    logo: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><circle cx="50" cy="50" r="46" fill="%23E20613" stroke="%23FFD100" stroke-width="4"/><text x="50" y="58" font-size="22" font-weight="900" font-family="sans-serif" fill="%23FFFFFF" text-anchor="middle">POS</text></svg>',
    primaryColor: '#E20613',
    secondaryColor: '#FFD100',
  },
  'fc talanta': {
    name: 'FC Talanta',
    shortName: 'TAL',
    logo: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><circle cx="50" cy="50" r="46" fill="%23005BAA" stroke="%23FFCD00" stroke-width="4"/><text x="50" y="58" font-size="22" font-weight="900" font-family="sans-serif" fill="%23FFFFFF" text-anchor="middle">TAL</text></svg>',
    primaryColor: '#005BAA',
    secondaryColor: '#FFCD00',
  },
  'sofapaka': {
    name: 'Sofapaka FC',
    shortName: 'SOF',
    logo: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><circle cx="50" cy="50" r="46" fill="%23003399" stroke="%23FFD700" stroke-width="4"/><text x="50" y="58" font-size="22" font-weight="900" font-family="sans-serif" fill="%23FFFFFF" text-anchor="middle">SOF</text></svg>',
    primaryColor: '#003399',
  ...
  'mara sugar': {
    name: 'Mara Sugar FC',
    shortName: 'MSU',
    logo: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><circle cx="50" cy="50" r="46" fill="%23008751" stroke="%23FFD100" stroke-width="4"/><text x="50" y="58" font-size="22" font-weight="900" font-family="sans-serif" fill="%23FFFFFF" text-anchor="middle">MSU</text></svg>',
    primaryColor: '#008751',
    secondaryColor: '#FFD100',
  },
  'mathare united': {
    name: 'Mathare United',
    shortName: 'MAT',
    logo: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><circle cx="50" cy="50" r="46" fill="%23008751" stroke="%23FEEB00" stroke-width="4"/><text x="50" y="58" font-size="22" font-weight="900" font-family="sans-serif" fill="%23FFFFFF" text-anchor="middle">MAT</text></svg>',
    primaryColor: '#008751',
    secondaryColor: '#FEEB00',
  },
  ...
  'simba': {
    name: 'Simba SC',
    shortName: 'SIM',
    logo: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><circle cx="50" cy="50" r="46" fill="%23DA291C" stroke="%23FFFFFF" stroke-width="4"/><text x="50" y="58" font-size="22" font-weight="900" font-family="sans-serif" fill="%23FFFFFF" text-anchor="middle">SIM</text></svg>',
    primaryColor: '#DA291C',
    secondaryColor: '#FFFFFF',
  },
  'young africans': {
    ...
    shortName: 'YAN',
    logo: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><circle cx="50" cy="50" r="46" fill="%23008751" stroke="%23FFD100" stroke-width="4"/><text x="50" y="58" font-size="22" font-weight="900" font-family="sans-serif" fill="%23FFFFFF" text-anchor="middle">YAN</text></svg>',
    primaryColor: '#008751',
    secondaryColor: '#FFD100',
  },
